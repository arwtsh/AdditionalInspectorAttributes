...
namespace ConditionalInspector
{
    ...
    /// </summary>
    public class HideInInspectorIfNotEqualAttribute : PropertyAttribute
    {
        public string propertyName;
        public object value;

        public HideInInspectorIfNotEqualAttribute(string _propertyName, object _value)
        {
    ...
    public class HideInInspectorIfNotEqualDrawer : HideInInspectorIfDrawer
    {
