...
namespace ConditionalInspector
{
    ...
    /// </summary>
    public class ShowInInspectorIfNotEqualAttribute : PropertyAttribute
    {
        public string propertyName;
        public object value;

        public ShowInInspectorIfNotEqualAttribute(string _propertyName, object _value)
        {
    ...
    public class ShowInInspectorIfNotEqualDrawer : HideInInspectorIfDrawer
    {
